...
print("RapidChain\t 33.3%\t 50%\t 50%\t", minCSize(n, n*Fraction(1, 3), Fraction(1, 2), k))
print("AHL\t\t 30%\t 50%\t 50%\t", minCSize(n, n*Fraction(3, 10), Fraction(1, 2), k))
print("Pyramid\t\t 12.5%\t 33.3%\t 33.3%\t", minCSize(n, n*Fraction(1, 8), Fraction(1, 3), k))
print("RIVET\t\t 33.3%\t 50%\t 50%\t", minCSize(n, n*Fraction(1, 3), Fraction(1, 2), k))
print("GEARBOX\t\t 30%\t 39%\t 30%\t", minCSize(n, n*Fraction(3, 10), Fraction(39, 100), k))
print("GEARBOX\t\t 20%\t 59%\t 20%\t", minCSize(n, n*Fraction(2, 10), Fraction(59, 100), k))
print("ARETE\t\t 33.3%\t 66.6%\t 33.3%\t", minCSize(n, n*Fraction(1, 3), Fraction(2, 3), k))
print("ARETE\t\t 20%\t 79%\t 20%\t", minCSize(n, n*Fraction(2, 10), Fraction(79, 100), k))