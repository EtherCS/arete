...
use crate::config::CertifyParameters;
...
fn spawn_nodes(
    ...
    keys.into_iter()
        ...
        .map(|(i, (name, secret))| {
            ...
            let parameters = CertifyParameters {
                certify_timeout_delay: 100,
                ..CertifyParameters::default()
            };
            ...
            let (_tx_confirm_mempool_to_consensus, rx_confirm_mempool_to_consensus) = channel(1);
